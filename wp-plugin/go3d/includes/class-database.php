...
class Go3D_Database {
    ...
    public static function install(): void {
        ...
        dbDelta( "CREATE TABLE {$wpdb->prefix}go3d_games (
            ...
            p1_periods        SMALLINT(5)           DEFAULT NULL,
            p2_periods        SMALLINT(5)           DEFAULT NULL,
            p1_in_byoyomi     TINYINT(1)   NOT NULL DEFAULT 0,
            p2_in_byoyomi     TINYINT(1)   NOT NULL DEFAULT 0,
